...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  package='grpc',
  syntax='proto3',
  serialized_pb=_b('\n\rcommand.proto\x12\x04grpc\x1a\x19google/protobuf/any.proto\"E\n\x0b\x45rrorStatus\x12\x0f\n\x07message\x18\x01 \x01(\t\x12%\n\x07\x64\x65tails\x18\x02 \x03(\x0b\x32\x14.google.protobuf.Any\"\x07\n\x05\x45mpty\"D\n\x0e\x43ommandRequest\x12\x0c\n\x04name\x18\x01 \x01(\t\x12$\n\x06params\x18\x02 \x03(\x0b\x32\x14.google.protobuf.Any\"(\n\x12\x43ommandHelprequest\x12\x12\n\nsubcommand\x18\x01 \x01(\t\"\x1f\n\x0f\x43ommandHelpResp\x12\x0c\n\x04help\x18\x01 \x01(\t2\x82\x01\n\x10\x43ommandInterface\x12\x32\n\x07\x43ommand\x12\x14.grpc.CommandRequest\x1a\x11.grpc.ErrorStatus\x12:\n\x07GetHelp\x12\x18.grpc.CommandHelprequest\x1a\x15.grpc.CommandHelpRespb\x06proto3')
  ,
...
_ERRORSTATUS = _descriptor.Descriptor(
  name='ErrorStatus',
  full_name='grpc.ErrorStatus',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='message', full_name='grpc.ErrorStatus.message', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='details', full_name='grpc.ErrorStatus.details', index=1,
...
ErrorStatus = _reflection.GeneratedProtocolMessageType('ErrorStatus', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:grpc.ErrorStatus)
  ))
